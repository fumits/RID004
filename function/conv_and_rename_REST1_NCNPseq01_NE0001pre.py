    ...
    for i in range(len(sublist)):
        ...
        for j in datelist_int:
            ...
            for fname in flist:
                ...
                elif 'DWI_AP' in fname and '24.nii.gz' in fname:
                    shutil.copy2(fname, Diff_AP_SBRef_fpath)
                elif 'DWI_AP' in fname and '25.nii.gz' in fname:
                    shutil.copy2(fname, Diff_AP_fpath)
                elif '25.bval' in fname:
                    shutil.copy2(fname, Diff_AP_bval_fpath)
                elif '25.bvec' in fname:
                    shutil.copy2(fname, Diff_AP_bvec_fpath)
                elif 'DWI_PA' in fname and '29.nii.gz' in fname:
                    shutil.copy2(fname, Diff_PA_SBRef_fpath)
                elif 'DWI_PA' in fname and '30.nii.gz' in fname:
                    shutil.copy2(fname, Diff_PA_fpath)
                elif '30.bval' in fname:
                    shutil.copy2(fname, Diff_PA_bval_fpath)
                elif '30.bvec' in fname:
