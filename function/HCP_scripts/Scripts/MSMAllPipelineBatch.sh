...
# StudyFolder="/mnt/d/HCP_analysis/Images" #Location of Subject folders (named by subjectID)
# Subjlist="sub-001" #Space delimited list of subject IDs
EnvironmentScript="/mnt/d/HCPPipeline/HCP_analysis/EnvScripts/SetUpHCPPipeline.sh" #Pipeline environment script
...
fMRINames=""
mrfixNames="rfMRI_REST_PA@rfMRI_REST_AP"
mrfixConcatName="rfMRI_REST_PA_AP"
mrfixNamesToUse="rfMRI_REST_PA@rfMRI_REST_AP"
