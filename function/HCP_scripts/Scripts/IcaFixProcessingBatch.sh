...
# DEFAULT_STUDY_FOLDER="/mnt/d/HCP_analysis/Images"
# DEFAULT_SUBJECT_LIST="sub-001"
DEFAULT_ENVIRONMENT_SCRIPT="/mnt/d/HCPPipeline/HCP_analysis/EnvScripts/SetUpHCPPipeline.sh"
...
main() {
	...
	ConcatNames=""
	ConcatNames="rfMRI_REST_PA_AP"  ## Use space (or @) to separate concatenation groups
